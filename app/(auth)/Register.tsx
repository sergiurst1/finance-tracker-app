    ...
    <ScreenWrapper>
      <View style={styles.container}>
        ...
        <View style={{gap: 5, marginTop: spacingY._20}}>
          <Typo style={styles.welcomeText}>Let's get started!</Typo>
        </View>

        <View style={styles.form}>
          <Typo size={15} color={colors.textLighter}>Create an account to track all your expences</Typo>
          <Input placeholder="Enter your name" onChangeText={(value) => (nameRef.current = value)} icon={<Icons.UserIcon size={verticalScale(26)} color={colors.neutral300}/>}></Input>
        ...
        <View style={styles.footer}>
          ...
          <Pressable onPress={() => router.navigate('/(auth)/Login')}>
            <Typo fontWeight={"500"} color={colors.primary}>Login</Typo>
          </Pressable>
        </View>
